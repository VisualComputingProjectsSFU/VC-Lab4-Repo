...
void DrawCurrentCamera(
    pangolin::OpenGlMatrix &Twc, float camerasize, float mCameraLineWidth)
{
...
int main(int argc, char *argv[])
{
    ...
    cout << "mViewpointX: " << mViewpointX << " " << mViewpointY;
    cout << " " << mViewpointZ << " " << mViewpointF << endl;
    ...
    while (i < rgb_files.size() - 1)
    {
        ...
        DrawCurrentCamera(
            Twc, 
            myslam::Config::get<float>("CameraSize"), 
            myslam::Config::get<float>("CameraLineWidth"));
